package ca.bcit.comp2613.a00832014.wow;
...
public class Wow {
	...
	private static void checkForPandaren(ArrayList<Character> characters) throws DontHaveExpansionException {
		...
		while (iterator.hasNext()) {
			Character character = iterator.next();
			if (character.getRace() == Race.PANDAREN) { //TODO not quite right is it?
				throw new DontHaveExpansionException("Don't Have Expansion");
			}
		}
	}
...
//		}
//
//		int total = (characters.size() + 1) * characters.size() / 2;
//		
//		System.out.println("missing is: " + (total - sum) + ", " + altSum);
//		return total; 
//	}
